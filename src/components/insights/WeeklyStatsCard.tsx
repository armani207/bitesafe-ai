...
import { Wheat, Flame, Activity, TrendingUp, TrendingDown, Minus } from 'lucide-react';
  ...
  return (
    <div className="grid grid-cols-2 gap-3">
      ...
      >
        <div className="mb-2 flex items-center justify-between">
          <div className="flex items-center gap-2">
            <div className="flex h-8 w-8 items-center justify-center rounded-lg bg-risk-medium/10">
              <Activity className="h-4 w-4 text-risk-medium" />
            </div>
            <span className="text-sm font-medium text-muted-foreground">Avg Risk Score</span>
          </div>
      ...
      <motion.div
        ...
        className="col-span-2 grid grid-cols-3 gap-3 rounded-xl border border-border bg-card p-4"
      >
